...
import { Support } from "@plasma/react";
...
```tsx title="src/App.tsx"
import { IdentifySupportVisitor, Support } from "@plasma/react";
...
```tsx title="src/App.tsx"
import { Support, SupportConfig } from "@plasma/react";
import { Support, SupportConfig } from "@plasma/react";
