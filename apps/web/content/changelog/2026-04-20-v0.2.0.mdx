...
<FrameworkInstallCommandTabs version="0.2.0" />

### Use Cossistant with a script tag

Perfect to use outside of React, with Vue, or in tools like Framer and Webflow.
Pin a specific version for predictable upgrades. Use `latest` only when you
intentionally accept a new, unreviewed widget release on the next page load.

```html showLineNumbers
<!-- Pin to a specific version -->
<script src="https://cdn.cossistant.com/widget/0.2.0/loader.js"></script>
<script>
...
<script src="https://cdn.cossistant.com/widget/latest/loader.js"></script>
<script>
  window.Cossistant.init({
    publicKey: "pk_live_...",
  });
