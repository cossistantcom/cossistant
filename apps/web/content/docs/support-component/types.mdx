...
description: Curated type reference for common Support props, hooks, events, and shared widget data.
search:
  kind: type
  tags:
    - types
...
Use this page as a curated index of the types most often linked by the Support
docs. The installed package declarations remain the complete contract for your
version.
